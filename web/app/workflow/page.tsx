        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 min-h-[700px]">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 flex flex-col border border-white/20"
            >
              ...
              <div className="flex-grow space-y-6">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="space-y-3">
                    <div className={`flex items-center gap-3 p-3 rounded-lg transition-all ${currentStep === 'analyzing' || currentStep === 'classified'
                        ? 'bg-green-500/20 border border-green-500/30'
                        : 'bg-gray-500/20 border border-gray-500/30'
                      }`}>
                      <div className={`w-3 h-3 rounded-full ${currentStep === 'analyzing' || currentStep === 'classified'
                    ...
                    <div className={`flex items-center gap-3 p-3 rounded-lg transition-all ${currentStep === 'classified'
                        ? 'bg-green-500/20 border border-green-500/30'
                        : 'bg-gray-500/20 border border-gray-500/30'
                      }`}>
                      <div className={`w-3 h-3 rounded-full ${currentStep === 'classified'
                          ? 'bg-green-500 animate-pulse'
                          : 'bg-gray-500'
                        }`} />
                    ...
                    >
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-4">
                          <div className={`p-3 rounded-xl ${currentReview.sentiment === 'negative'
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              <p className={`text-lg font-semibold ${currentReview.sentiment === 'negative' ? 'text-red-400' : 'text-green-400'
                                }`}>
            ...
            >
              ...
              <div className="flex-grow space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`w-full py-4 px-6 rounded-xl font-semibold text-white transition-all flex items-center justify-center gap-3 text-lg shadow-lg ${currentStep !== 'typing'
                  ...
                  <div className="space-y-3 max-h-48 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
                    {dummyReviews.map((review, index) => (
                      <motion.div
                        ...
                        className={`p-4 rounded-xl border-l-4 transition-all ${index === currentReviewIndex
                      ...
                      >
                        ...
                        <div className="flex justify-between items-center">
                          <div className="flex items-center gap-2">
                            <div className="flex">
                              {Array(5).fill(0).map((_, i) => (
                                <Star
                                  key={i}
                                  className={`w-4 h-4 ${review.sentiment === 'positive' && i < 4
                          ...
                          <span className={`text-xs px-2 py-1 rounded-full font-medium ${review.sentiment === 'positive'
